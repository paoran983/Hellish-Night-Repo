...
public class MoveUI : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler {
    [SerializeField] private Image itemImage;
    [SerializeField] private TMP_Text countText;
    [SerializeField] private Image borderImage;
    private MoveListSO parentInventory;
    // delagate that allows to call the following functions 
    public event Action<MoveUI> onItemClicked, onItemDroppedOn,
        onItemBeginDrag, onItemEndDrag, onRightMouseBtnClick, onPointerEnter, onPointerExit, onPointerClick;
    public event Action<MoveUI, MoveUI> onDroppedOnDifInventory;
    public bool empty = true;
    private int index;
    private MoveSO itemData;
